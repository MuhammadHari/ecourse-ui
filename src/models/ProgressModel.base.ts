...
export const ProgressModelBase = withTypedRefs<Refs>()(ModelBase
  ...
  .props({
    ...
    content: types.union(types.undefined, MSTGQLRef(types.late((): any => ContentModel))),
    section: types.union(types.undefined, MSTGQLRef(types.late((): any => SectionModel))),
...
export class ProgressModelSelector extends QueryBuilder {
  ...
  content(builder?: string | ContentModelSelector | ((selector: ContentModelSelector) => ContentModelSelector)) { return this.__child(`content`, ContentModelSelector, builder) }
